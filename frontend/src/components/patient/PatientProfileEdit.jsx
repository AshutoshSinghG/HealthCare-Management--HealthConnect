          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <input value={form.address.zipCode} onChange={e => updateAddress('zipCode', e.target.value.replace(/\D/g, ''))} className="input-base" type="text" inputMode="numeric" placeholder="Zip Code" minLength={5} maxLength={9} />
              </div>
              <div className="space-y-1.5">
